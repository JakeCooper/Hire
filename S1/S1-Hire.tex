...
Our technology stack will be organized into a client server model. Connections will be initiated through a front-end (either Android or iOS) and requests will be handled by a server written in Scala \cite{scala}. 
...
The final piece will be handling monetary transactions, which will be completed using the PayPal REST API \cite{paypal}. Using a mature service like PayPal will ensure that monetary transactions are fast secure and simple.
