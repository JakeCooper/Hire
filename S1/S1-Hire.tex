...
The following section details four example interactions between hirer or hirees and the Hire platform. The four scenarios are,
...
\begin{description}
    ...
    \item[Getting hired on the go] Trish gets notified about a job to pick up a hirer's dry cleaning on her way home from work.
\end{description}
...
\subsubsection{Hiring on the Go}
